...
#Region "可扩展性方法定义"
    ...
    End Sub
    Partial Private Sub InsertContainerType(ByVal instance As ContainerType)
    End Sub
    Partial Private Sub UpdateContainerType(ByVal instance As ContainerType)
    End Sub
    Partial Private Sub DeleteContainerType(ByVal instance As ContainerType)
    End Sub
    Partial Private Sub InsertHistory(ByVal instance As History)
    End Sub
    Partial Private Sub UpdateHistory(ByVal instance As History)
    End Sub
    Partial Private Sub DeleteHistory(ByVal instance As History)
    End Sub
    Partial Private Sub InsertPackageItem(ByVal instance As PackageItem)
    End Sub
    Partial Private Sub UpdatePackageItem(ByVal instance As PackageItem)
    End Sub
    Partial Private Sub DeletePackageItem(ByVal instance As PackageItem)
    End Sub
    Partial Private Sub InsertPackagingEvent(ByVal instance As PackagingEvent)
    End Sub
    Partial Private Sub UpdatePackagingEvent(ByVal instance As PackagingEvent)
    End Sub
    Partial Private Sub DeletePackagingEvent(ByVal instance As PackagingEvent)
    End Sub
    Partial Private Sub InsertPart(ByVal instance As Part)
    End Sub
    Partial Private Sub UpdatePart(ByVal instance As Part)
    End Sub
    Partial Private Sub DeletePart(ByVal instance As Part)
    End Sub
    Partial Private Sub InsertPartAllowedSec(ByVal instance As PartAllowedSec)
    End Sub
    Partial Private Sub UpdatePartAllowedSec(ByVal instance As PartAllowedSec)
    End Sub
    Partial Private Sub DeletePartAllowedSec(ByVal instance As PartAllowedSec)
    End Sub
    Partial Private Sub InsertPartContainerLabel(ByVal instance As PartContainerLabel)
    End Sub
    Partial Private Sub UpdatePartContainerLabel(ByVal instance As PartContainerLabel)
    End Sub
    Partial Private Sub DeletePartContainerLabel(ByVal instance As PartContainerLabel)
    End Sub
    Partial Private Sub InsertProdLine(ByVal instance As ProdLine)
    End Sub
    Partial Private Sub UpdateProdLine(ByVal instance As ProdLine)
    End Sub
    Partial Private Sub DeleteProdLine(ByVal instance As ProdLine)
    End Sub
    Partial Private Sub InsertProject(ByVal instance As Project)
    End Sub
    Partial Private Sub UpdateProject(ByVal instance As Project)
    End Sub
    Partial Private Sub DeleteProject(ByVal instance As Project)
    End Sub
    Partial Private Sub InsertSinglePackage(ByVal instance As SinglePackage)
    End Sub
    Partial Private Sub UpdateSinglePackage(ByVal instance As SinglePackage)
    End Sub
    Partial Private Sub DeleteSinglePackage(ByVal instance As SinglePackage)
    End Sub
    Partial Private Sub InsertSourceBarcode(ByVal instance As SourceBarcode)
    End Sub
    Partial Private Sub UpdateSourceBarcode(ByVal instance As SourceBarcode)
    End Sub
    Partial Private Sub DeleteSourceBarcode(ByVal instance As SourceBarcode)
    End Sub
    Partial Private Sub InsertWorkStation(ByVal instance As WorkStation)
    End Sub
    Partial Private Sub UpdateWorkStation(ByVal instance As WorkStation)
    End Sub
    Partial Private Sub DeleteWorkStation(ByVal instance As WorkStation)
    End Sub
#End Region
...
Partial Public Class PackageItem
    ...
    Partial Private Sub OnCreated()
    End Sub
    Partial Private Sub OnItemUidChanging(value As Integer)
    End Sub
	...
	<Global.System.Data.Linq.Mapping.ColumnAttribute(Name:="itemUid", Storage:="_ItemUid", AutoSync:=AutoSync.OnInsert, DbType:="Int NOT NULL IDENTITY", IsPrimaryKey:=true, IsDbGenerated:=true),  _
	 Global.System.Runtime.Serialization.DataMemberAttribute(Order:=1)>  _
...
Partial Public Class SinglePackage
	...
	<Global.System.Data.Linq.Mapping.ColumnAttribute(Name:="planedDate", Storage:="_PlanedDate", DbType:="DateTime NOT NULL"),  _
	 Global.System.Runtime.Serialization.DataMemberAttribute(Order:=5)>  _
